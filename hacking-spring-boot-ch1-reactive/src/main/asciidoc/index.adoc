...
include::{snippets}/aggregate-root-affordances/http-request.adoc[]

===== curl

include::{snippets}/aggregate-root-affordances/curl-request.adoc[]

===== HTTPie

include::{snippets}/aggregate-root-affordances/httpie-request.adoc[]

==== 응답

include::{snippets}/aggregate-root-affordances/http-response.adoc[]

===== 응답 본문

include::{snippets}/aggregate-root-affordances/response-body.adoc[]
...
include::{snippets}/single-item-affordances/http-request.adoc[]

===== curl

include::{snippets}/single-item-affordances/curl-request.adoc[]

===== HTTPie

include::{snippets}/single-item-affordances/httpie-request.adoc[]

==== 응답

include::{snippets}/single-item-affordances/http-response.adoc[]

===== 응답 본문

include::{snippets}/single-item-affordances/response-body.adoc[]